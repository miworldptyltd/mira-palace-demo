...
<link rel="stylesheet" href="{root}assets/css/site.css?v=21" />
...
def footer(root: str) -> str:
    ...
    <script src="{root}assets/js/media-manifest.js?v=26" defer></script>
    <script src="{root}assets/js/search-index.js?v=26" defer></script>
    <script src="{root}assets/js/i18n.js?v=26" defer></script>
    <script src="{root}assets/js/site.js?v=26" defer></script>
    </body></html>
    """)
